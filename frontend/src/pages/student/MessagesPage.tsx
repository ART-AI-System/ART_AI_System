import { Edit, Search, Phone, Video, MoreVertical, Paperclip, Smile, Send, CheckCheck } from 'lucide-react';
import { Card } from '../../components/common/Card';

const MessagesPage = () => {
  return (
    <div className="flex-1 overflow-hidden h-[calc(100vh-6rem)] -mt-8 -mx-8 bg-[#F4F7FE] p-6">
        ...
        <div className="w-1/3 border-r border-gray-100 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto" style={{ scrollbarWidth: 'none' }}>
            ...
            <div className="flex items-center p-4 bg-blue-50/50 border-l-4 border-[#4318FF] cursor-pointer">
              <div className="relative">
                <img src="https://ui-avatars.com/api/?name=Dr.+Smith&background=EBF4FF&color=0072BC" alt="Dr. Smith" className="w-12 h-12 rounded-full" />
            ...
            <div className="flex items-center p-4 hover:bg-gray-50 cursor-pointer transition-colors border-l-4 border-transparent">
              <div className="relative">
                <img src="https://ui-avatars.com/api/?name=Mike+Ross&background=FCE7F3&color=BE185D" alt="Mike Ross" className="w-12 h-12 rounded-full opacity-80" />
              </div>
              <div className="ml-4 flex-1">
                <div className="flex justify-between items-baseline mb-1">
        ...
        <div className="flex-1 flex flex-col bg-white relative">
          ...
          <div className="h-20 border-b border-gray-100 flex justify-between items-center px-6">
            <div className="flex items-center">
              <div className="relative">
                <img src="https://ui-avatars.com/api/?name=Dr.+Smith&background=EBF4FF&color=0072BC" alt="Dr. Smith" className="w-10 h-10 rounded-full shadow-sm" />
          ...
          {/* Chat Messages */}
          <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-gray-50/30" style={{ scrollbarWidth: 'none' }}>
            ...
            <div className="flex items-end">
              <img src="https://ui-avatars.com/api/?name=Dr.+Smith&background=EBF4FF&color=0072BC" alt="Dr. Smith" className="w-8 h-8 rounded-full mb-1" />
            ...
            <div className="flex items-end justify-end">
              ...
              <img src="https://ui-avatars.com/api/?name=Viet+Khoa&background=F26F21&color=fff" alt="Me" className="w-8 h-8 rounded-full mb-1" />
            </div>
